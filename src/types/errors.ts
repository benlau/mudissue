export type ErrorCode =
  ...
  | "MERMAID_LEGACY_DEPS_MISSING"
  | "SCRIPT_SELECT_ISSUE_CANCELLED"
  | "SCRIPT_SELECT_ITEM_CANCELLED"
  | "SCRIPT_VAR_INVALID_NAME"
  | "SCRIPT_VAR_NOT_FOUND"
  | "SCRIPT_VAR_VALUE_REQUIRED"
  | "SCRIPT_VAR_CLEAR_WITH_VALUE"
  | "COMMAND_INVALID_ARG"
