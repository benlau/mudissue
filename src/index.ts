...
const msg = defineMessages({
  ...
  demandIssue: {
    id: "cli.demand.issue",
    defaultMessage:
      "Specify 'create', 'edit', 'view', 'cat', 'set-property', 'get-property', 'search', 'remove', 'archive', 'merge', 'locate', 'rename', 'change-id', 'tag', 'untag', 'comment', 'append', 'prepend', 'touch', 'link', 'unlink', 'branch', 'worktree', or 'file'",
  },
  demandRegistry: {
